    ...
    public partial class Form2 : Form
    {
            ...
            {      
...

                {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        cur = new TextLable(e.Location, e.Location, f1.brushSize, f1.colorLine, f1.colorFon);//выбор класса текста
                      
					((TextLable)cur).tFont = textFont;
					((TextLable)cur).f2 = this;
                        break;
        ...
        {          
            ...
            if (isMouseDown)
            {
                ...
                cur.DrawDash(BuffGrapics.Graphics, AutoScrollPosition);
                BuffGrapics.Render();
            }
        }
